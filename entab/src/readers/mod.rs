...
pub fn get_reader<'r>(
    ...
    Ok(match parser_type {
        ...
        "chemstation_fid" => Box::new(agilent::ChemstationFidReader::new(rb, ())?),
        "chemstation_ms" => Box::new(agilent::ChemstationMsReader::new(rb, ())?),
        "chemstation_mwd" => Box::new(agilent::ChemstationMwdReader::new(rb, ())?),
        "chemstation_uv" => Box::new(agilent::ChemstationUvReader::new(rb, ())?),
